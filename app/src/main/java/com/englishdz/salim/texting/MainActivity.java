...
public class MainActivity extends AppCompatActivity {
    ...
    // Allows use to update the UI with new messages by telling the Activity to update the UI every 5 seconds
    // A handler can schedule for code to execute at a set time in this Activities thread
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                if (bundle != null) {
                    ...
                    // Store data as a PDU (Protocol Data Unit) which includes the number and text
                    final Object[] pdusObj = (Object[]) bundle.get("pdus");

                    // Cycle through the data received
                    for (int i = 0; i < pdusObj.length; i++) {
                        // Create an SMS message from the raw PDU data
                        ...
                        // This is used to block the receiving number

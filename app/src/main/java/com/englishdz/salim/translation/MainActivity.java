...
public class MainActivity extends Activity implements TextToSpeech.OnInitListener {
    ...
    // You must install all of these on your phone for text to speech (Settings - Language & Input - Text-to-speech output - Preferred Engine Settings - Install voice data
    ...
    protected boolean isEmpty(EditText editText) {
        ...
        // Get the text in the EditText and convert it into a string, delete whitespace and check length
    ...
    public void readTheText(View view) {
        ...
        if (arrayOfTranslations.length >= 9) {
            ...
            // QUEUE_FLUSH deletes previous text to read and replaces it with nex text
    ...
    class GetXMLData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            TextView translateTextView = (TextView) findViewById(R.id.translation_text_view);

            // Make the TextView scrollable
            translateTextView.setMovementMethod(new ScrollingMovementMethod());

            // Eliminate the "language :" part of the string for the translation
    ...
    public void ExpectSpeechInput(View view) {
        ...
        // Recognize speech based on the default speech device

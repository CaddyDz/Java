...
public class DetailsFragment extends Fragment {
    ...
    // ViewGroup is the view to contain the fragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        // applyDimensions receives the unit type to use which is COMPLEX_UNIT_DIP, which is Device Independent Pixels
        ...
        // Set the currently selected hero's data to the textView
